...
public class Movie implements Parcelable {
    ...
    private Trailer_Response videos;
    ...
    @Ignore
    public Movie(String posterPath, String overview, String releaseDate, List<Integer> genreIds, Integer movieId,
    ...
    public Trailer_Response getMovieTrailer() {
        return videos;
    }

    public void setMovieTrailer(Trailer_Response MovieTrailer) {
        this.videos = videos;
    }
    ...
    private Movie(Parcel in) {
        ...
        this.videos = in.readParcelable(Trailer_Response.class.getClassLoader());
